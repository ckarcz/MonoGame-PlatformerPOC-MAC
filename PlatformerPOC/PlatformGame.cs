...
namespace PlatformerPOC
{
	public class PlatformGame : Game, IAppender
	{
		...
		protected override void LoadContent ()
		{
			...
			new GoreFactory (this);
			new SpawnPlayersHandler (this);
			new StartGameHandler (this);     
			new CheckGameStateHandler (this);
			new ShootHandler (this);
			new PowerupPickedUpHandler (this);     

			EventAggregator.GetEvent<StartGameMessage> ().Publish (new StartGameMessage ());
		...
		protected override void Update (GameTime gameTime)
		{
			...
			EventAggregator.GetEvent<CheckGameStateMessage> ().Publish (new CheckGameStateMessage ());            
